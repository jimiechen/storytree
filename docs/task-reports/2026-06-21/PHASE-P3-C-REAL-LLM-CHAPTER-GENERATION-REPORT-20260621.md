...
| 类型 | Commit | 说明 |
|------|--------|------|
| 代码 | `TBD_CODE_COMMIT` | feat(novel): P3-C real LLM chapter generation with context budget and retry |
| 文档 | `TBD_DOCS_COMMIT` | docs(novel): add Phase P3-C implementation report and records |

...
export default function ProjectsPage() {
  ...
  return (
    <div className="flex-1 bg-transparent flex flex-col relative text-white">
      {/* Top Navigation */}
      <header className="h-20 flex items-center justify-between px-10 border-b border-white/5 sticky top-0 z-40 bg-[#11111a]/90 backdrop-blur-xl">
        <div className="flex items-center gap-10">
          <div className="flex flex-col">
            <h1 className="font-serif text-3xl font-bold text-[#75d1ff] tracking-wide">织梦笔</h1>
            <span className="text-[10px] text-white/40 tracking-[0.2em] font-medium mt-1">AI 驱动的长篇小说创作平台</span>
          </div>
          
          <nav className="hidden md:flex items-center gap-8 ml-8">
            <button className="text-[11px] font-bold tracking-widest text-[#75d1ff] border-b-2 border-[#75d1ff] pb-2 pt-2">DASHBOARD</button>
            <button className="text-[11px] font-bold tracking-widest text-white/50 hover:text-white transition-colors pb-2 pt-2 border-b-2 border-transparent">TIMELINE</button>
            <button className="text-[11px] font-bold tracking-widest text-white/50 hover:text-white transition-colors pb-2 pt-2 border-b-2 border-transparent">COLLABORATORS</button>
          </nav>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div className="relative group">
            ...
            <input
              className="bg-white/5 border border-white/10 rounded-full pl-12 pr-4 py-2 text-sm text-white focus:ring-1 focus:ring-[#75d1ff]/40 w-72 transition-all placeholder:text-white/30"
          ...
          <button className="w-8 h-8 rounded-full bg-gradient-to-tr from-[#eab308] to-[#ca8a04] overflow-hidden border border-white/20 p-0.5">
            <div className="w-full h-full rounded-full bg-black/50 backdrop-blur flex items-center justify-center">
              <span className="material-symbols-outlined text-[16px] text-white/90">person</span>
            </div>
          </button>
        </div>
      </header>

      <div className="flex-1 p-10 space-y-12 max-w-[1400px] mx-auto w-full">
        {/* Dashboard Top Grid */}

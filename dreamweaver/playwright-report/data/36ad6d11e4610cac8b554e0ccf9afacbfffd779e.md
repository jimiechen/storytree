...
- Name: projects/list.spec.ts >> 项目列表页面 >> 项目列表显示 - 显示多个项目卡片
- Location: tests/e2e/projects/list.spec.ts:40:7
...
Locator: locator('.project-card, [data-testid="project-card"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.project-card, [data-testid="project-card"]').first()

...
- Name: auth/register.spec.ts >> 注册页面 >> 注册失败 - 邮箱已被注册
- Location: tests/e2e/auth/register.spec.ts:92:7
...
Locator: locator('text=/邮箱已被注册|email already exists/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/邮箱已被注册|email already exists/i').first()
...
- generic [active] [ref=e1]:
  - generic [ref=e4]:
    ...
    - generic [ref=e8]:
      - generic [ref=e9]:
        - generic [ref=e10]: 用户名
        - textbox "请输入用户名" [ref=e11]: testuser
      - generic [ref=e12]:
        - generic [ref=e13]: 邮箱
        - textbox "请输入邮箱" [ref=e14]: test@example.com
      - generic [ref=e15]:
        - generic [ref=e16]: 密码

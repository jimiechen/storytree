...
- Name: projects/list.spec.ts >> 项目列表页面 >> 新建项目按钮 - 跳转到新建项目页面
- Location: tests/e2e/projects/list.spec.ts:80:7
...
Expected pattern: /.*projectscreate/
Received string:  "http://localhost:3000/projects/create"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    3 × unexpected value "http://localhost:3000/projects"
    6 × unexpected value "http://localhost:3000/projects/create"
...
> 87  |     await expect(page).toHaveURL(/.*projectscreate/);
  ...
  111 |         
  112 |         // 验证页面更新
  113 |         await expect(page).toHaveURL(/.*page=\d+/);
  114 |       }
  115 |     }
  116 |   });
  117 | });

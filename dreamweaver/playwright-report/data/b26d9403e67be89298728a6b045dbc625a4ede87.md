...
- Name: auth/register.spec.ts >> 注册页面 >> 表单验证 - 邮箱格式无效
- Location: tests/e2e/auth/register.spec.ts:44:7
...
- generic [ref=e1]:
  - generic [ref=e4]:
    ...
    - generic [ref=e7]:
      - generic [ref=e8]:
        - generic [ref=e9]: 用户名
        - textbox "请输入用户名" [ref=e10]: testuser
      - generic [ref=e11]:
        - generic [ref=e12]: 邮箱
        - textbox "请输入邮箱" [active] [ref=e13]: invalid-email
      - generic [ref=e14]:
        - generic [ref=e15]: 密码

...
- Name: auth/register.spec.ts >> 注册页面 >> 表单验证 - 用户名为空
- Location: tests/e2e/auth/register.spec.ts:29:7
...
Locator: locator('text=/用户名不能为空|username is required/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/用户名不能为空|username is required/i').first()
...
- generic [ref=e1]:
  - generic [ref=e4]:
    ...
    - generic [ref=e7]:
      - generic [ref=e8]:
        - generic [ref=e9]: 用户名
        - textbox "请输入用户名" [active] [ref=e10]
      - generic [ref=e11]:
        - generic [ref=e12]: 邮箱
        - textbox "请输入邮箱" [ref=e13]: test@example.com
      - generic [ref=e14]:
        - generic [ref=e15]: 密码
        - textbox "请输入密码（至少8位）" [ref=e16]: password123
      - button "注册" [ref=e17]

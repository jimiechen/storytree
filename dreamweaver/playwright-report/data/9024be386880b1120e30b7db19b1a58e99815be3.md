...
- Name: workbench/chapters.spec.ts >> Chapter Navigation Component >> should display chapter list
- Location: tests/e2e/workbench/chapters.spec.ts:4:7
...
Locator: locator('[data-testid="chapter-list"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="chapter-list"]')

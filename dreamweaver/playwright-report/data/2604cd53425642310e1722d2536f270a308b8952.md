...
- Name: projects/create.spec.ts >> 新建项目功能 >> 表单验证 - 项目标题不能为空
- Location: tests/e2e/projects/create.spec.ts:34:7
...
Locator: locator('text=/标题不能为空|title is required|请输入项目标题/').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/标题不能为空|title is required|请输入项目标题/').first()
  ...
  - generic [ref=e14]:
    ...
    - generic [ref=e19]:
      - generic [ref=e20]:
        ...
        - textbox "请输入项目标题" [active] [ref=e22]
      - generic [ref=e23]:
        - generic [ref=e24]: 项目描述
        - textbox "项目描述" [ref=e25]:
          - /placeholder: 请输入项目描述（可选）
          - text: 这是一个测试项目
        - paragraph [ref=e26]: 8/1000
      - generic [ref=e27]:
        - button "取消" [ref=e28]
        - button "创建项目" [ref=e29]
```

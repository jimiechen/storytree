...
- Name: projects/list.spec.ts >> 项目列表页面 >> 搜索过滤功能 - 搜索项目
- Location: tests/e2e/projects/list.spec.ts:58:7
...
Locator: locator('.project-card, [data-testid="project-card"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.project-card, [data-testid="project-card"]')
...
- generic [ref=e1]:
  - generic [ref=e3]:
    - generic [ref=e4]:
      ...
      - button "新建项目" [ref=e8]
    - searchbox "搜索项目..." [active] [ref=e11]: test

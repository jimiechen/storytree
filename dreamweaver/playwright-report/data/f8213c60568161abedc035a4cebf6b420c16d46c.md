...
- Name: workbench/chapters.spec.ts >> Chapter Navigation Component >> should allow clicking on chapters to switch content
- Location: tests/e2e/workbench/chapters.spec.ts:34:7
...
Call log:
  - waiting for locator('[data-testid="editor-content"]')

...
- Name: workbench/chapters.spec.ts >> Chapter Navigation Component >> should display active chapter indicator
- Location: tests/e2e/workbench/chapters.spec.ts:54:7
...
Locator: locator('[data-testid="chapter-item"].active')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="chapter-item"].active')

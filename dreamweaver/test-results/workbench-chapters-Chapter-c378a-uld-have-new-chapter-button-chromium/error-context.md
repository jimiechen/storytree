...
- Name: workbench/chapters.spec.ts >> Chapter Navigation Component >> should have new chapter button
- Location: tests/e2e/workbench/chapters.spec.ts:75:7
...
Locator: locator('[data-testid="new-chapter-button"]')
Expected: visible
Timeout: 5000ms

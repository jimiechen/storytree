...
- Name: auth/login.spec.ts >> 登录页面 >> 表单验证 - 密码为空
- Location: tests/e2e/auth/login.spec.ts:38:7
...
Locator: locator('text=/密码不能为空|password is required/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/密码不能为空|password is required/i').first()
...
- generic [ref=e1]:
  - generic [ref=e4]:
    ...
    - generic [ref=e7]:
      - generic [ref=e8]:
        - generic [ref=e9]: 邮箱
        - textbox "请输入邮箱" [ref=e10]: test@example.com
      - generic [ref=e11]:
        - generic [ref=e12]: 密码
        - textbox "请输入密码" [active] [ref=e13]
      - button "登录" [ref=e14]

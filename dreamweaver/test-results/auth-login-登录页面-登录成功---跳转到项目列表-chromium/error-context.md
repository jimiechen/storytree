...
- Name: auth/login.spec.ts >> 登录页面 >> 登录成功 - 跳转到项目列表
...
- generic [active] [ref=e1]:
  - generic [ref=e4]:
    ...
    - generic [ref=e7]: 邮箱或密码错误
    - generic [ref=e8]:
      - generic [ref=e9]:
        - generic [ref=e10]: 邮箱
        - textbox "请输入邮箱" [ref=e11]: test@example.com
      - generic [ref=e12]:
        - generic [ref=e13]: 密码
        - textbox "请输入密码" [ref=e14]: password123
      - button "登录" [ref=e15]
    - link "还没有账号？立即注册" [ref=e17] [cursor=pointer]:
      - /url: /register

...
- Name: projects/create.spec.ts >> 新建项目功能 >> 表单验证 - 项目描述长度限制
- Location: tests/e2e/projects/create.spec.ts:70:7
...
Locator: locator('text=/描述长度|description length|描述不能超过/').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/描述长度|description length|描述不能超过/').first()

...
export enum ErrorCode {
  ...
  NETWORK_ERROR = -30999,
  PROJECT_NOT_FOUND = -30998,
  CHAPTER_NOT_FOUND = -30997,
  CHARACTER_NOT_FOUND = -30996,
  WORLD_SETTING_NOT_FOUND = -30995,
  DUPLICATE_RESOURCE = -30994,
  VALIDATION_ERROR = -30993,
  FILE_SYSTEM_ERROR = -30992,
  DATABASE_ERROR = -30991,
  AI_SERVICE_ERROR = -30990,
  AI_MODEL_OVERLOADED = -30989,
  CONTEXT_LENGTH_EXCEEDED = -30988,
  SANDBOX_VIOLATION = -30987,
  ENCRYPTION_ERROR = -30986,
}

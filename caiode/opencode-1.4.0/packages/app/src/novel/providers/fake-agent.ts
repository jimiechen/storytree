...
const mockTemplates: Record<AITaskType, string[]> = {
  ...
  'chapter-generation': [
    '青云山下，晨雾尚未散尽。少年李玄第一次握住那柄锈迹斑斑的古剑，掌心传来一阵奇异的温热。他不知道，从这一刻起，自己的命运将与整座大陆的风云紧密相连。',
    '传送阵的光芒渐渐熄灭，苏瑶睁开眼，发现自己正站在一座悬浮于云海之上的古老城市边缘。远处，巨大的齿轮缓缓转动，发出低沉而悠远的轰鸣。',
    '雨夜，破旧的客栈里只剩下一盏昏黄的油灯。陆长风端起酒杯，目光却落在墙角那个浑身湿透的神秘少女身上。她的手中，紧紧握着一块刻满未知符文的碎片。'
  ],
  'rewrite-selection': [
